...
var map = {
	...
	"./list-expandable/list-expandable.module": [
		"./src/app/list-expandable/list-expandable.module.ts",
		"common",
		"list-expandable-list-expandable-module"
	],
	"./list-fade-in/list-fade-in.module": [
		"./src/app/list-fade-in/list-fade-in.module.ts",
		"list-fade-in-list-fade-in-module"
	],
	"./list-infinte-scroll/list-infinte-scroll.module": [
		"./src/app/list-infinte-scroll/list-infinte-scroll.module.ts",
		"list-infinte-scroll-list-infinte-scroll-module"
	],
	"./list-refresher/list-refresher.module": [
		"./src/app/list-refresher/list-refresher.module.ts",
		"list-refresher-list-refresher-module"
	],
	"./list-reorder/list-reorder.module": [
		"./src/app/list-reorder/list-reorder.module.ts",
		"list-reorder-list-reorder-module"
	],
	"./list-slide-left/list-slide-left.module": [
		"./src/app/list-slide-left/list-slide-left.module.ts",
		"list-slide-left-list-slide-left-module"
	],
	"./list-slide-right/list-slide-right.module": [
		"./src/app/list-slide-right/list-slide-right.module.ts",
		"list-slide-right-list-slide-right-module"
	],
	"./list-swipe-full-image/list-swipe-full-image.module": [
		"./src/app/list-swipe-full-image/list-swipe-full-image.module.ts",
		"common",
		"list-swipe-full-image-list-swipe-full-image-module"
	],
	"./list-swipe-left-to-right/list-swipe-left-to-right.module": [
		"./src/app/list-swipe-left-to-right/list-swipe-left-to-right.module.ts",
		"common",
		"list-swipe-left-to-right-list-swipe-left-to-right-module"
	],
	"./list-swipe-right-to-left/list-swipe-right-to-left.module": [
		"./src/app/list-swipe-right-to-left/list-swipe-right-to-left.module.ts",
		"common",
		"list-swipe-right-to-left-list-swipe-right-to-left-module"
	],
	"./list-swipe-thumbnail-products/list-swipe-thumbnail-products.module": [
		"./src/app/list-swipe-thumbnail-products/list-swipe-thumbnail-products.module.ts",
		"common",
		"list-swipe-thumbnail-products-list-swipe-thumbnail-products-module"
	],
	"./list-swipe-with-header/list-swipe-with-header.module": [
	...
	"./tab-footer-icon/tab-footer-icon.module": [
		"./src/app/tab-footer-icon/tab-footer-icon.module.ts",
		"tab-footer-icon-tab-footer-icon-module"
	],
	"./tab-footer-text-icon-badge/tab-footer-text-icon-badge.module": [
		"./src/app/tab-footer-text-icon-badge/tab-footer-text-icon-badge.module.ts",
		"tab-footer-text-icon-badge-tab-footer-text-icon-badge-module"
	],
	"./tab-footer-text-icon/tab-footer-text-icon.module": [
		"./src/app/tab-footer-text-icon/tab-footer-text-icon.module.ts",
		"tab-footer-text-icon-tab-footer-text-icon-module"
	],
	"./tab-footer-text/tab-footer-text.module": [
		"./src/app/tab-footer-text/tab-footer-text.module.ts",
		"tab-footer-text-tab-footer-text-module"
	],
	"./tab-header-icon/tab-header-icon.module": [
		"./src/app/tab-header-icon/tab-header-icon.module.ts",
		"tab-header-icon-tab-header-icon-module"
	],
	"./tab-header-text-icon-badge/tab-header-text-icon-badge.module": [
		"./src/app/tab-header-text-icon-badge/tab-header-text-icon-badge.module.ts",
		"tab-header-text-icon-badge-tab-header-text-icon-badge-module"
	],
	"./tab-header-text-icon/tab-header-text-icon.module": [
		"./src/app/tab-header-text-icon/tab-header-text-icon.module.ts",
		"tab-header-text-icon-tab-header-text-icon-module"
	],
	"./tab-header-text/tab-header-text.module": [
	...
	"./toast-bottom/toast-bottom.module": [
		"./src/app/toast-bottom/toast-bottom.module.ts",
		"toast-bottom-toast-bottom-module"
	],
	"./toast-middle/toast-middle.module": [
		"./src/app/toast-middle/toast-middle.module.ts",
		"toast-middle-toast-middle-module"
	],
	"./toast-top/toast-top.module": [
		"./src/app/toast-top/toast-top.module.ts",
		"toast-top-toast-top-module"
	],
	"./toggle-simple-left/toggle-simple-left.module": [
		"./src/app/toggle-simple-left/toggle-simple-left.module.ts",
		"toggle-simple-left-toggle-simple-left-module"
	],
	"./toggle-with-avatar/toggle-with-avatar.module": [
...
var AppComponent = /** @class */ (function () {
    ...
    function AppComponent(platform, splashScreen, statusBar, menuCtrl, modalCntrl, nav, navCtrl, events, statusbar, elementRef, articleService, storage) {
        ...
        this.events.subscribe('icons', function (data) {
            _this.iconColorVar = data;
            if (data == "autumn") {
                _this.itemColor = ["#F44336"];
                _this.elementRef.nativeElement.style.setProperty('--my-var', _this.itemColor);
            }
            else if (data == "night") {
                _this.itemColor = ["#673AB7"];
                _this.elementRef.nativeElement.style.setProperty('--my-var', _this.itemColor);
            }
            else if (data == "neon") {
                _this.itemColor = ["#03A9F4"];
                _this.elementRef.nativeElement.style.setProperty('--my-var', _this.itemColor);
            }
            else if (data == "orginal") {
                _this.itemColor = ["#4CAF50"];
                _this.elementRef.nativeElement.style.setProperty('--my-var', _this.itemColor);
            }
            else if (data == "red") {
                _this.itemColor = ["#9E9E9E"];
                _this.elementRef.nativeElement.style.setProperty('--my-var', _this.itemColor);
            }
            else if (data == "purple") {
                _this.itemColor = ["#E91E63"];
                _this.elementRef.nativeElement.style.setProperty('--my-var', _this.itemColor);
            }
            else if (data == "Lightblue") {
                _this.itemColor = ["#3F51B5"];
                _this.elementRef.nativeElement.style.setProperty('--my-var', _this.itemColor);
            }
            else if (data == "Lightgreen") {
                _this.itemColor = ["#00BCD4"];
                _this.elementRef.nativeElement.style.setProperty('--my-var', _this.itemColor);
            }
            else if (data == "Lightgray") {
                _this.itemColor = ["#8BC34A"];
                _this.elementRef.nativeElement.style.setProperty('--my-var', _this.itemColor);
            }
            else if (data == "blue") {
                _this.itemColor = ["#008577"];
                _this.elementRef.nativeElement.style.setProperty('--my-var', _this.itemColor);
            }
        });
    }
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.storage.get('bookmarkArticles').then(function (result) {
            if (result) {
                _this.bookmarkCount = result.length;
            }
        });
    };
    ...
    AppComponent.prototype.initializeLatestArticle = function () {
        var _this = this;
        this.articleService.getLatestArticle().subscribe(function (res) {
            if (res && res.length) {
                _this.articlesCount = res.length; //assigning category name
            }
        });
    };
...
var ArticleService = /** @class */ (function () {
    ...
    function ArticleService(http) {
        ...
        this.baseUrl = 'http://13.235.138.126/api/v1';
        this.httpOptions = {
    ...
    ArticleService.prototype.getCategory = function () {
        return this.http.get(this.baseUrl + '/get_category')
    ...
    ArticleService.prototype.getIndex = function (cat_id) {
        return this.http.get(this.baseUrl + '/get_index/' + cat_id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandl));
    };
    ArticleService.prototype.getArticle = function (index_id) {
        return this.http.get(this.baseUrl + '/get_article/' + index_id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandl));
    };
    ArticleService.prototype.getLatestArticle = function () {
        return this.http.get(this.baseUrl + '/latest_article')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandl));
    };
    // Error handling
    ArticleService.prototype.errorHandl = function (error) {
        var errorMessage = '';
...
/***/ "./src/app/components/menu-component/menu-component.component.html":
/*!*************************************************************************!*\
  !*** ./src/app/components/menu-component/menu-component.component.html ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/menu-component/menu-component.component.scss":
/*!*************************************************************************!*\
  !*** ./src/app/components/menu-component/menu-component.component.scss ***!
  \*************************************************************************/
/*! no static exports found */
...
var MenuComponentComponent = /** @class */ (function () {
    function MenuComponentComponent(renderer) {
        this.renderer = renderer;
        this.expanded = false;
        this.expandHeight = "150px";
    }
    MenuComponentComponent.prototype.ngAfterViewInit = function () {
    ...
    MenuComponentComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./menu-component.component.html */ "./src/app/components/menu-component/menu-component.component.html"),
            styles: [__webpack_require__(/*! ./menu-component.component.scss */ "./src/app/components/menu-component/menu-component.component.scss")]
        }),
...
/***/ "./src/app/providers/bookmark_index.ts":
/*!*********************************************!*\
  !*** ./src/app/providers/bookmark_index.ts ***!
  \*********************************************/
/*! exports provided: FavoriteProvider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FavoriteProvider", function() { return FavoriteProvider; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var STORAGE_KEY = 'bookmarkArticles';
var FavoriteProvider = /** @class */ (function () {
    ...
    FavoriteProvider = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
...
/***/ "./src/app/providers/recent_index.ts":
/*!*******************************************!*\
  !*** ./src/app/providers/recent_index.ts ***!
  \*******************************************/
/*! exports provided: RecentProvider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RecentProvider", function() { return RecentProvider; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ionic_storage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/storage */ "./node_modules/@ionic/storage/fesm5/ionic-storage.js");
...
var STORAGE_KEY = 'recentArticles';
var RecentProvider = /** @class */ (function () {
    function RecentProvider(storage) {
        this.storage = storage;
    }
    RecentProvider.prototype.isFavorite = function (filmId) {
        return this.getAllFavoriteFilms().then(function (result) {
            return result && result.indexOf(filmId) !== -1;
        });
    };
    RecentProvider.prototype.favoriteFilm = function (filmId) {
        var _this = this;
        return this.getAllFavoriteFilms().then(function (result) {
            if (result) {
                result.push(filmId);
    ...
    RecentProvider.prototype.unfavoriteFilm = function (filmId) {
        var _this = this;
        return this.getAllFavoriteFilms().then(function (result) {
            if (result) {
                var index = result.indexOf(filmId);
    ...
    RecentProvider.prototype.getAllFavoriteFilms = function () {
        return this.storage.get(STORAGE_KEY);
    };
    RecentProvider = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"]])
    ], RecentProvider);
